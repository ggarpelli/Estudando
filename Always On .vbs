...
lngMinutes = InputBox("Guilherme, por quanto tempo deseja ficar disponivel?" & Replace(Space(5), " ", vbNewLine) & "Enter minutes:", "Tempo Acordado") 'we are replacing 5 spaces with new lines
